...
preferences {
    page(name: "mainPage", title: "Install Video Camera", install: true, uninstall:true) {
        ...
        section("Add a Camera") {
            ...
            ["rtsp://user:password@[ipaddress]/Streaming/Channels/1":"RTSP Camera"], //hikvision
            ["http://[ipaddress]:[port]/mjpeg.cgi?user=user&password=password&channel=1.mjpeg":"MJPEG.cgi Camera"], //dlink 932l
            ["http://user:password@[ipaddress]/nphMotionJpeg?Resolution=640x480&Quality=Standard":"MotionJpeg Camera"] //panasonic bl-140c
